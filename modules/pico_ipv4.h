...
int pico_ipv4_route_add(const struct pico_ip4 *address, const struct pico_ip4 *netmask, const struct pico_ip4 *gateway, int metric, struct pico_ipv4_link *link);
